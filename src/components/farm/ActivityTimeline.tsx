    ...
    <div className="px-4 py-4 space-y-5">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          title="Get advice for this activity"
        >
      ...
      {tab === "tasks" && (
        <div className="space-y-2">
          {activity.tasks.length === 0 && (
            <p className="text-sm text-muted-foreground text-center py-6">No tasks generated for this activity.</p>
          )}
      ...
      {tab === "records" && (
        <div className="space-y-3">
          {records.length === 0 && (
            <p className="text-sm text-muted-foreground text-center py-6">No records logged yet. Start by logging a farming event.</p>
          )}
          {records
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-primary/30 p-3 text-sm font-medium text-primary transition-colors hover:bg-primary/5"
          >
