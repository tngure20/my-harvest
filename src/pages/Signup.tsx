        ...
        >
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              <h1 className="font-display text-2xl font-bold text-foreground">Join Harvest</h1>
          ...
          <button
            type="button"
            className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-border bg-card px-4 py-3 text-sm font-medium text-foreground transition-colors hover:bg-muted"
          >
